...
/** Created by C.J.YOU on 2017/1/12. File 操作的工具类， 封装成class便于重写其方法和复用
  */
class FileContentWriter {
  ...
  /** write to file
    ...
    *   data
    * @param isAppend
    *   文件追加与否 if true, then bytes will be written to the end of the file rather
    *   than the beginning
    */
  def normalFileWriter(
      path: String,
      array: Array[String],
